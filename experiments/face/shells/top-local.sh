...
export PYTHONPATH=/Users/lingxiao/Documents/camera-project/code/story-board
...
cd /Users/lingxiao/Documents/camera-project/code/story-board
...
# run my scripts
python /Users/lingxiao/Documents/camera-project/code/story-board/experiments/face/top.py
